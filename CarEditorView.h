...
public:
	...
	void DrawObjectTextures(Object3D *object,double x,double y,double z);
...
protected:
	...
	afx_msg void OnFileExportwavefrontobj();
	afx_msg void OnLButtonDblClk(UINT nFlags, CPoint point);
	afx_msg void OnEditRcrdistances();
	afx_msg void OnShowCockpit();
	afx_msg void OnUpdateShowCockpit(CCmdUI* pCmdUI);
	afx_msg void OnShowSwheel();
	afx_msg void OnUpdateShowSwheel(CCmdUI* pCmdUI);
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};

#ifndef _DEBUG  // debug version in CarEditorView.cpp
inline CCarEditorDoc* CCarEditorView::GetDocument()
