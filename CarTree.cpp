...
int CCarTree::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
	...
	rc2.right = cx;
	rc2.bottom = cy;
	if (!m_CarTree.CreateEx(WS_EX_CLIENTEDGE,TVS_HASLINES  | TVS_HASBUTTONS | TVS_SHOWSELALWAYS | TVS_DISABLEDRAGDROP | WS_VISIBLE | WS_CHILD | WS_BORDER ,rc2,this,IDC_CARTREE))
       return -1;
